...
if model == 'theta':
    ...
    fixed_params = {'labels': [0,1,2,4,5],
                    'values': vals}
    labels2 = ['bias']
    directory = '.\\results_tmp\\split_cond_theta\\'
    ...
    fixed_params = {'labels': [0,2,3,4,5],
                    'values': vals}
    labels2 = ['beta']
    directory = '.\\results_tmp\\split_cond_beta\\'
    ...
    fixed_params = {'labels': [0,2,4,5],
                    'values': vals}
    labels2 = ['beta','bias']
    directory = '.\\results_tmp\\split_cond_theta_beta\\'
    ...
    directory = '.\\results_tmp\\split_cond_theta_beta_gamma\\'
    ...
    directory = '.\\results_tmp\\split_cond_theta_beta_kappa\\'
    ...
    directory = '.\\results_tmp\\split_cond_theta_beta_gamma_kappa\\'
...
for j, cond in enumerate(['hard','medium','easy']):
    # Index to selext condition and miniblock segment
    idx = ((tmp['start_condition'] == (1+j*2))|(tmp['start_condition'] == (2+j*2))) & (tmp['phase'] > 1)
